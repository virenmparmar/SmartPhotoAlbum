...
apigClientFactory.newClient = function (config) {
    ...
    var invokeUrl = 'https://1lg8v04mqc.execute-api.us-east-1.amazonaws.com/beta';
    ...
    apigClient.uploadBucketKeyPut = function (params, body, additionalParams) {
        ...
        apiGateway.core.utils.assertParametersDefined(params, ['key', 'bucket', 'x-amz-meta-CustomLabels', 'Access-Control-Allow-Origin', 'Access-Control-Allow-Origin-Headers', 'Access-Control-Allow-Methods'], ['body']);
        ...
        var uploadBucketKeyPutRequest = {
            ...
            headers: apiGateway.core.utils.parseParametersToObject(params, ['x-amz-meta-CustomLabels', 'Access-Control-Allow-Origin', 'Access-Control-Allow-Origin-Headers', 'Access-Control-Allow-Methods']),
            queryParams: apiGateway.core.utils.parseParametersToObject(params, []),
            body: body
        };
    ...
    apigClient.uploadBucketKeyOptions = function (params, body, additionalParams) {
        ...
        apiGateway.core.utils.assertParametersDefined(params, ['key', 'bucket', 'Access-Control-Allow-Origin', 'Access-Control-Allow-Headers', 'Access-Control-Allow-Methods'], ['body']);
